  ...
  <div class="container">
    ...
    <form method="post" action="<?php $_SERVER['PHP_SELF'] ?>" onsubmit="return validateInput()">
      <table style="width:98%">
        <tr>
          <td>
            <div class='mb-3'>
              First Name:
              <input type='text' class='form-control' id='first' name='first' value="<?php if ($patient_to_update != null)
          ...
          <td>
            <div class='mb-3'>
              Last Name:
              <input type='text' class='form-control' id='last' name='last' value="<?php if ($patient_to_update != null)
          ...
          <td>
            <div class='mb-3'>
              Gender:
              <input type='text' class='form-control' id='gender' name='gender' value="<?php if ($patient_to_update != null)
        ...
        <tr>
          <td>
            <div class='mb-3'>
              DOB:
              <input type='text' class='form-control' id='DOB' name='DOB' value="<?php if ($patient_to_update != null)
          ...
          <td>
            <div class='mb-3'>
              SSN:
              <input type='text' class='form-control' id='SSN' name='SSN' value="<?php if ($patient_to_update != null)
          ...
          <td>
            <div class='mb-3'>
              Ethnicity:
              <input type='text' class='form-control' id='ethnicity' name='ethnicity' value="<?php if ($patient_to_update != null)
      ...
      <div class="row g-3 mx-auto">
        ...
        <div class="col-4 d-grid ">
          <input type="submit" value="Confirm update" id="cofmBtn" name="cofmBtn" class="btn btn-primary" title="Update a patient record" />
  ...
  <div class="container">
    ...
    <div class="row justify-content-center">
      <table class="w3-table w3-bordered w3-card-4" style="width:100%">
        ...
        <tbody>
          <!-- Iterate over each patient and display their information -->
